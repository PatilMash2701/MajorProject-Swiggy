    ...
    return(
        <header className="bg-[#ff5200] ">
            <div className="flex justify-between container mx-auto py-8">
                <img src="https://res.cloudinary.com/dutdah0l9/image/upload/v1720058694/Swiggy_logo_bml6he.png" className="w-40 h-10"></img>
            ...
            <div className="pt-16 pb-8 relative">
                ...
                <div className=" max-w-[60%] text-5xl text-white font-bold container mx-auto text-center">
                    Order Food & Groceries.Discover best Restorants.Swiggy it
                </div>
                <div className="max-w-[60%] container mx-auto flex gap-5 mt-7">
                    <input className="bg-white w-[35%] text-xl px-6 py-3 rounded-2xl" placeholder="Delhi, India"></input>
                    <input className="bg-white w-[55%] text-xl px-6 py-3 rounded-2xl" placeholder="Search for restaurant and items for more"></input>
                </div>
            </div>
